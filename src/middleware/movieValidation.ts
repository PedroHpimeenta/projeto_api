...
export const movieCreateValidation = () => {
    return [body("title").isString().withMessage("O título é obrigatório").isLength({min:5}).withMessage("O titulo precisa ter no minimo 5 caracteres"),
    ...
    body ("poster").isURL().withMessage("A imagem precisa ter um URL"),
